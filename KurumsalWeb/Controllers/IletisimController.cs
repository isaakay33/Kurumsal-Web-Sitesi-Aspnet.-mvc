...
namespace KurumsalWeb.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Telefon,Fax,Whatsaap,Facebook,Twitter,Instegram")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Telefon,Fax,Whatsaap,Facebook,Twitter,Instegram")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
